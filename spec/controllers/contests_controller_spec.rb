...
describe ContestsController do
  ...
  let(:valid_attributes) { { "contest_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contest as @contest" do
        ...
        post :create, {:contest => { "contest_name" => "invalid value" }}, valid_session
        assigns(:contest).should be_a_new(Contest)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contest" do
        ...
        Contest.any_instance.should_receive(:update_attributes).with({ "contest_name" => "MyString" })
        put :update, {:id => contest.to_param, :contest => { "contest_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contest as @contest" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contest.any_instance.stub(:save).and_return(false)
        put :update, {:id => contest.to_param, :contest => { "contest_name" => "invalid value" }}, valid_session
        assigns(:contest).should eq(contest)
      end
